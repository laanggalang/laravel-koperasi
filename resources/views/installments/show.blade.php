...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        <a href="{{ route('installments.index') }}" class="p-2 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors" title="Kembali ke Riwayat Angsuran">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
            </svg>
        </a>
        <h2 class="text-xl font-bold text-gray-800">Kembali ke Riwayat Angsuran</h2>
    </div>
