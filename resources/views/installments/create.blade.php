...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        <a href="{{ route('installments.index') }}" class="p-2 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors" title="Kembali">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Pilih kode pinjaman anggota dan masukkan jumlah nominal angsuran yang dibayarkan.</p>
        </div>
    </div>
    ...
    <div class="card">
            <form action="{{ route('installments.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="flex justify-end space-x-3 pt-5 border-t border-gray-100">
                    <a href="{{ route('installments.index') }}" class="btn-secondary">Batal</a>
